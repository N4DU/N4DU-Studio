...
import { shapePath, radiusFor, cropRect } from './geometry.js';
...
export function drawRegion(ctx, img, sx, sy, sw, sh, dx, dy, dw, dh) {
...
// background: color de fondo para formatos sin transparencia (JPG).
export function renderOutput(state, W, H, background = null) {
